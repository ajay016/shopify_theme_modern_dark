...
TESTS=[
 ...
 ("Filter Style", 'filter_style', ['sidebar','drawer','dropdown','toggle'],
   lambda o,val: {'sidebar':'collection-sidebar' in o,'drawer':'data-open-filter-drawer' in o,
                  'dropdown':'dropdown-filter' in o,'toggle':'aria-expanded="false"' in o}[val]),
